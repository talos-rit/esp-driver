...
static inline uint16_t ads1015_build_config(
    ads1015_mux_t mux, ads1015_pga_t pga, ads1015_mode_t mode, ads1015_dr_t dr,
    ads1015_comp_mode_t comp_mode, ads1015_comp_pol_t comp_pol,
    ads1015_comp_lat_t comp_lat, ads1015_comp_que_t comp_que,
    bool start_conversion) {
  return ((start_conversion ? 1 : 0) << ADS1015_OS_BIT) |
         (mux << ADS1015_MUX_SHIFT) | (pga << ADS1015_PGA_SHIFT) |
         (mode << ADS1015_MODE_BIT) | (dr << ADS1015_DR_SHIFT) |
