...
static encoder_config_t config = {
    ...
    .gear_ratio = (float)CONFIG_ENCODER_0_LIMB_GEAR_RATIO_X /
                  (float)CONFIG_ENCODER_0_LIMB_GEAR_RATIO_Y,
...
//         .resolution = CONFIG_ENCODER_0_RESOLUTION ,
//         .gear_ratio = (float)CONFIG_ENCODER_0_LIMB_GEAR_RATIO_X /
//         (float)CONFIG_ENCODER_0_LIMB_GEAR_RATIO_Y , .limb_default =
//         CONFIG_ENCODER_0_LIMB_REFERENCE, .invert_angle =
//         CONFIG_ENCODER_0_ANGLE_INVERT
//     } ;
